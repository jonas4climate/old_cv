...
\begin{tightemize}
    ...
    %\item [\faicon{angle-double-right}] \textbf{In just three weeks} I recognized opportunities for improvement and implemented software solutions
...
\begin{tightemize}
    \item \href{https://github.com/j0ner0n/PhysicsSim}{\texttt{\faicon{download} Simulator}} of \textbf{gravitational forces in 3D space} capable of performing \textbf{complex \href{https://en.wikipedia.org/wiki/N-body_problem}{n-body simulations}} with \textbf{extensive logging output}, \textbf{collision detection}, \textbf{real-time mode} and more features.
