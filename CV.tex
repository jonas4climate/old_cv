...
\location{Dec 2019}
\begin{tightemize}
    \item \href{https://github.com/j0ner0n/mobile-scheduling-app/blob/master/final-doc/software-engineering-g21.pdf}{\texttt{\faicon{github} Application Proposal}} for a Mental Health App that automates large parts of daily scheduling to help students organise themselves
...
\location{Nov 2019}
\begin{tightemize}
    \item \href{https://github.com/j0ner0n/PhysicsSim}{\texttt{\faicon{github} Simulator}} of gravitational forces in 3D space capable of performing \textbf{complex \href{https://en.wikipedia.org/wiki/N-body_problem}{n-body simulations}} with extensive logging output, collision detection, real-time mode and more features.
